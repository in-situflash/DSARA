...
parser.add_argument('--test_best', default=True,
                    help='whether load the best checkpoint')
parser.add_argument('--arch', type=str, default='DSARA', help='which architecture to use')
...
def main():
    ...
    if args.white_box_attack:
        ...
        if args.test_best:
            args.checkpoint = 'EXP/best.pth.tar'
            ...
            for i in range(74, 75):
                args.checkpoint = 'EXP/checkpoint-epoch' + str(i) + '.pth.tar'
                print(args.checkpoint)
